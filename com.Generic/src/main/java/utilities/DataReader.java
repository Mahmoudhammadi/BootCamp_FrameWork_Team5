...
public class DataReader {
    ...
    public static  Object[][] fileReader4(String path,String sheetName) throws IOException, InvalidFormatException {
        ...
        team5 = book.getSheet(sheetName);
        Object[][] data1 = new Object[team5.getLastRowNum()][team5.getRow(0).getLastCellNum()];
        for (int i = 0; i < team5.getLastRowNum(); i++) {
            for (int j = 0; j < team5.getRow(0).getLastCellNum(); j++) {
                data1[i][j] = team5.getRow(i + 1).getCell(j).toString();
            }
        }
        return data1;
    }
