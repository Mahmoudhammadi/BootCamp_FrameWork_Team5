...
//Step:3--> Check the href url, with http connection api
    ...
    public boolean verifyLinks(List<WebElement> linksExploreNearbyDest, String src) {
    ...
    /**
     *
     * @Author: Krimo Abdedou
     * @Main : The following method return as list of string any
     * ul list of WebElement getting their text
     */
   public List<String> getElements(String locator){
        List<WebElement> list =  driver.findElements(By.xpath(locator));
        List<String > listToString = new ArrayList<>();

        Iterator<WebElement> itElement = list.iterator();
         while (itElement.hasNext()){
             WebElement elementli = itElement.next();
             String text = elementli.getText();
             listToString.add(text);
         }
         return listToString;
   }
//button popup
